...
struct FinanceData: Codable {
    ...
    struct Holding: Codable, Identifiable {
        ...
        private enum CodingKeys: String, CodingKey {
            case symbol, shares, costBasis, currency, marketValue, account, source
        }

        init(symbol: String, shares: Double, costBasis: Double, currency: String? = nil, marketValue: Double? = nil, account: String? = nil, source: String? = nil) {
            self.symbol = symbol
            self.shares = shares
